...
public class RedBlackTree {
    ...
    public RedBlackTree() {
     ...
     class Node {
        ...
        Node rotateLeft(Node node) {
            ...
            x.left = node;
            node.right = y;
            node.parent = x;    // parent resetting is alsoimportant.
            if(y != null)
                y.parent = node;
                return(x);
            }
    ...
    if(this.ll) {
        ...
        // when rotation and recolouring is done flagsare reset.
        // Now lets take care of RED RED conflict
        if(f) {
            // to check which child is the currentnode of its parent
